        ...
        <div className="row">
          <div className="col-md-8">
            ...
            <p>
              ...
              don&apos;t have the option to use NextJS at my current employment,
              I thought it would be a good opportunity to create a simple
              website of my own. In addition to giving me a chance to explore
              and learn about NextJS, it can serve as a playground for other
              tech ideas I want to explore and a public demonstration of some of
              the types of things I am able to work on (since my professional
              code is all closed-source).
            </p>
